...
Сектор: Коммерческие"""
    ...
    def test8(self):
        html = self.get_data('2015-10-12.html')

        parser = YandexParser(html)
        serp = parser.get_serp()

        self.assertTrue(YandexParser.is_yandex(html))
        self.assertEquals(serp['pc'], 443000)
        self.assertEquals(len(serp['sn']), 50)
...
serp_1_snippets = [
    ...
    (6, "http://www.EuroOkna.ru/", u"Пластиковые окна ПВХ: ...от производителя № 1 в Москве....", u"Готовые пластиковые окна полностью соответствуют международным стандартам и отлично подходят под местные климатические условия.", False, False),
    (7, "http://www.ecookna.ru/", u"\"Экоокна\" - пластиковые окна и двери", u"Производство пластиковых окон и дверей, остекление балконов и лоджий, изготовление зимних садов и др. Онлайн-расчет стоимости окна. Информация о скидках. Адреса офисов продаж.", False, False),
    (8, "http://sobesednik.ru/proisshestviya/20150623-malchik-vypal-iz-okna-v-voskresenske-iz-za-moskitnoy-setki", u"Мальчик выпал из окна в Воскресенске из-за москитной...", u"Шестилетний мальчик выпал из окна третьего этажа жилого дома в подмосковном Воскресенске. Ребёнок лежит в реанимации.", False, False),
    (9, "http://www.OknaRosta.ru/", u"\"Окна Роста\" - продажа пластиковых окон", u"Пластиковые окна, алюминиевые конструкции, деревянные окна. Описание продукции. Конструктор окон и расчет стоимости онлайн. Список дилеров. Контакты.", False, False),
    (10, "http://www.Okna-Lider.com/", u"\"Окна лидер\" - пластиковые окна и двери", u"Производство пластиковых окон, входных дверей, металлических решеток на окна, остекление балконов, устройство натяжных потолков. Цены. Условия доставки, оплаты и сроки изготовления. Контакты.", False, False),
    (11, "http://www.Plastok.ru/", u"\"Пласток\" - пластиковые окна и двери", u"Производство и продажа окон, балконных дверей, комплектующих к ним, а также поставки жалюзей и штор, кондиционеров и др. Цены. Адреса мест продаж.", False, False),
    (12, "http://www.okna-plastek.ru/", u"Окна пвх из Германии, купить окна пвх в москве, немецкие...", u"Мы рекомендуем обратить внимание на немецкие окна Саламандра, в Москве их продажей занимаются несколько компаний, но большинство из них, в отличие от нас...", False, False),
    (13, "http://www.oknaprosvet.ru/", u"\"Просвет\" - пластиковые окна", u"Производство, продажа и монтаж окон из профилей Rehau и Provedal, остекление балконов и лоджий. Цены. Информация для дилеров. Контакты.", False, False),
    (14, "http://www.OknaMaster.ru/", u"\"Окна Мастер\" - продажа пластиковых окон", u"Изготовление и установка окон из ПВХ, полный комплекс услуг по монтажу; остекление фасадов, лоджий и балконов. Адреса офисов.", False, False),
    (15, "http://oknovam.ru/", u"Галерея окон - ...окна по дешевым ценам в Москве...", u"Заказать пластиковые окна в Москве по выгодной цене и превосходному качеству вам поможет компания «Галерея окон».", False, False),
    (16, "http://www.OknaKomforta.ru/", u"\"Окна Комфорта\" - пластиковые окна", u"Производство пластиковых окон из профилей Veka, остекление балконов и лоджий. Онлайн-калькулятор стоимости окон. Условия продажи в кредит.", False, False),
    (17, "http://Okna-Magnit.ru/", u"\"Окна-Магнит\" - изготовление пластиковых окон", u"Оптовая поставка ПВХ-профиля и комплектующих для производства пластиковых окон, собственное производство окон, остекление балконов и лоджий. Форма для вызова замерщика. Контакты.", False, False),
    (18, "http://www.MosOkna.ru/", u"Пластиковые окна - ...пластиковые окна на заказ в Москве", u"Московские окна — крупнейший производитель пластиковых окон в России. Современное автоматизированное производство по запатентованным технологиям...", False, False),
    (19, "http://www.sm-okna.ru/", u"\"Строй Мастер\" - пластиковые окна", u"Изготовление и установка окон из немецкого профиля Rehau, остекление лоджий и балконов. Каталог продукции. Калькулятор стоимости окон. Контакты.", False, False),
    (20, "http://www.veka.ru/", u"\"Veka\" - производитель окон и дверей", u"Описание продукции: оконные профильные системы, двери, рольставни, декоративные перекладины и пр. Адреса представительств.", False, False),
    (21, "http://torg.mail.ru/okna/", u"Окна - где купить по выгодным ценам. Характеристики...", u"Самый большой выбор где купить окна - 357 предложений. Информация по отзывам и магазинам на Товары@Mail.ru.", False, False),
    (22, "http://www.hobbit.ru/", u"Пластиковые окна в Москве от производителя заказать...", u"качественные пластиковые окна производятся на заводе с 1992 года ... офисы продаж и выставочные стенды пластиковых окон от производителя в крупных ТЦ Москвы и...", False, False),
    (23, "http://www.OknaLux.ru/", u"Пластиковые окна пвх Thyssen, KBE в Москве недорого...", u"Пластиковые окна с витражным стеклом. Витражи на окнах украсят вашу квартиру или дом. Пластиковые окна для ресторана. Установлены окна пвх в ресторане.", False, False),
    (24, "http://www.Okna5.ru/", u"\"Отличные окна\" - изготовление пластиковых окон", u"Изготовление, монтаж и обслуживание окон и дверей из ПВХ. Система расчета стоимости и онлайн-заказа. Сведения о компании. Контакты.", False, False),
    (25, "http://www.ramokna.ru/", u"\"РАМокна\" - пластиковые окна", u"Продажа, ламинация и установка пластиковых окон, остекление балконов и лоджий. Цены. Контакты.", False, False),
    (26, "http://www.oknasok.ru/", u"\"Самарские оконные конструкции\" - окна из ПВХ", u"Производство и установка пластиковых окон, подоконников и дверей, оптовая продажа профиля SOK и конструкций из него. Калькулятор для расчета стоимости окон. Контакты.", False, False),
    (27, "http://okna-kurs.ru/", u"Продажа деревянных окон для квартиры на заказ в Москве", u"Купить деревянные окна в Москве вовсе не составит труда, если воспользоваться услугами компании «Курс».", False, False),
    (28, "http://Avrora-Okna.ru/", u"\"Аврора-Окна\" - пластиковые и деревянные окна", u"Продажа, установка и ремонт окон, остекление балконов, строительство зимних садов и др. услуги. Цены, онлайн-расчёт стоимости окон. Информация об акциях и спецпредложениях. Фотографии объектов.", False, False),
    (29, "http://www.OknaSite.ru/", u"\"Ваши теплые окна\" - производство деревянных окон", u"Производство, продажа и монтаж деревянных, дерево-алюминиевых окон со стеклопакетами, евроокон, арочных окон из древесины дуба и др. Стоимость. Фотогалерея готовых работ.", False, False),
    (30, "http://okna-virtual.ru/", u"Заказать пластиковые окна / Купить окна ПВХ в Москве...", u"Самые выгодные цены на пластиковые окна в Москве и области. Если Вы решили купить пластиковые окна ПВХ в Москве...", False, False),
    (31, "http://nww.ru/", u"Новые окна - производитель пластиковых окон.", u"Производство и продажа пластиковых окон из ПВХ и алюминия, кованых изделий; оборудования для производства окон и для деревообработки. Цены. Галерея работ. Онлайн-калькулятор.", False, False),
    (32, "http://www.oknamedia.ru/", u"\"Окна медиа\" - портал о пластиковых окнах", u"Каталог производителей окон, отзывы о компаниях-установщиках. Новости, обзоры и аналитика рынка. Динамика цен, оконный калькулятор. Форум, фото- и видеоматериалы.", False, False),
    (33, "http://www.formulaokna.ru/", u"\"Формула окна\" - пластиковые окна", u"Производство, монтаж и сервисное обслуживание пластиковых окон и дверей, стеклопакетов, витражей и др. Цены, калькулятор стоимости. Фотогалерея готовых работ. Отзывы клиентов. Адреса мест продаж.", False, False),
    (34, "http://www.okna-best.ru/", u"ООО Компания ОКНА", u"АКЦИЯ!!!Купив окна в нашей компании Вы можете стать обладателем автомобиля VOLGSWAGEN JETTA или стеклочистителя KARHER.", False, False),
    (35, "http://www.oknamir.ru/", u"Главная страница - Окна Мир", u"Изготовление, доставка и установка различных видов пластиковых окон, витражей, вентилируемых фасадов, зимних садов, дверей и др. Статьи. Контакты.", False, False),
    (36, "http://www.premium-okna.ru/pvc.html", u"Пластиковые окна ПВХ используемые в Москве...", u"Пластиковые окна идеально гармонируют с любым архитектурным стилем зданий: от нестареющей классики до авангардных дизайнерских проектов.", False, False),
    (37, "http://www.oknalina.ru/", u"Окна Лина: Пластиковые окна в Москве и Московской...", u"Компания «Окна Лина» - тепло и уют вашего дома! 10 лет вместе в Вами! Качественные оконные и дверные конструкции, офисные перегородки, жалюзи.", False, False),
    (38, "http://oknalegion.ru/", u"Пластиковые окна ПВХ в Москве", u"Установка пластиковых, деревянных и алюминиевых окон, отделка балконов. Онлайн-расчёт стоимости окна. Онлайн-заявка на вызов замерщика. Галерея работ.", False, False),
    (39, "http://www.glavokna.ru/", u"\"Главокна\" - пластиковые окна", u"Изготовление и установка окон, остекление балконов и лоджий. Цены на продукцию. Информация о скидках. Технические описания профилей. Советы по эксплуатации. Контакты.", False, False),
    (40, "http://www.okna-yes.ru/", u"\"Okna-yes\" - монтаж окон и остекление балконов", u"Изготовление и монтаж пластиковых окон и алюминиевых конструкций, остекление, утепление и отделка балконов. Описание продукции. Цены. Фотогалерея.", False, False),
    (41, "http://msk.localmart.ru/okna/", u"Окна б/у Московская область : продать, купить окно...", u"Продам окна ПВХ. Новые, готовые, в наличии. Двухкамерный стеклопакет, поворотно-откидная створка: (В)100*(Ш)100-стоим... избранное Москва.", False, False),
    (42, "http://www.format-okna.ru/", u"Пластиковые окна и двери - \"Формат-Окна\", отзывы", u"Качественные пластиковые окна от компании «Формат-Окна». Наша компания «Формат-Окна» работает с 1998 года и за это время зарекомендовала себя...", False, False),
    ...
    (44, "http://www.oknadoz.ru/", u"Купить пластиковые окна: цены в Москве. Производство...", u"Пластиковые окна в Москве могут быть изготовлены не только белого цвета, но и любого другого подходящего для Ваших целей.", False, False),
    (45, "http://www.oknacm2.ru/", u"Пластиковые окна в Москве, производство, монтаж...", u"Изготовление и монтаж ПВХ-окон и дверей, офисных перегородок, систем остекление балконов, зимних садов и пр. Калькулятор расчета стоимости заказа. Онлайн-вызов замерщика. Адреса мест продаж.", False, False),
    (46, "http://www.okna-super.ru/calculator/", u"...окна калькулятор. Стоимость пластиковых окон в Москве", u"«Делали ремонт и решили обновить окна. Обратились в «Окна Супер» и попросили сделать двустороннюю ламинацию окон.", False, False),
    (47, "http://market.yandex.ru/catalog/91726/list?page=3&clid=703", u"Окна — Результаты поиска — Яндекс.Маркет", u"Мансардные окна Velux обеспечивает на 30-40% больше света, чем слуховое окно с такой же площадью остекления.", False, False),
    (48, "http://www.oknamoskvy.ru/", u"Пластиковые окна (окна ПВХ) в Москве: установка...", u"Пластиковые окна от фирмы «Окна Москвы». Компания «Окна Москвы» высоко зарекомендовала себя в области производства и установки пластиковых окон и ПВХ...", False, False),
    (49, "http://www.FabOkon.ru/", u"\"Фабокон\" - пластиковые окна и двери", u"Производство, продажа и установка пластиковых окон и дверей, остекление балконов и лоджий, отделка откосов и др. Калькулятор стоимости окон. Акции, программы скидок. Фотогалерея. Контакты.", False, False),
    (50, "http://veramo.ru/", u"\"Верамо\" - пластиковые окна Veka и Rehau", u"Замер, изготовление и монтаж окон. Описание профильных систем, цветовая гамма, цены. Контакты.", False, False),
]
...
serp_2_snippets = [
    ...
    (6, "http://magazilla.ru/desc/hummer-h5/", u"Мобильный телефон Hummer H5. Описание... - Москва", u"Характеристики и описание Hummer H5. ... Мобильный телефон Защищенный телефон Hummer H5+ black-green Video-shoper.ru (Москва).", False, False),
    (7, "http://rezervacija.com.ua/products/hummer-h5", u"Защищенные телефоны Hummer H5 купить со скидкой...", u"Hummer H5 - защищенный, противоударный, водонепроницаемый смартфон.", False, False),
    (8, "http://www.e-katalog.ru/HUMMER-H5.htm", u"Hummer H5 – купить мобильный телефон, сравнение цен...", u"Мобильный телефон Защищенный телефон Hummer H5+ black-green. Защищенный смартфон Hummer H5 со степенью защиты IP68.", False, False),
    (9, "http://runbo-extreme.ru/product/hummer-h5", u"Купить Hummer H5, продажа защищенного смартфона...", u"Благодаря низкой цене защищённого смартфона Hummer H5, его обладателем может стать любой желающий.", False, False),
    (10, "http://china-techcom.com/hummer-h5-mt6572.html", u"Hummer H5 противоударный водонепроницаемый купить...", u"7400 руб. Китайские защитные смартфоны вроде Hummer H5 ориентированы на людей, которые привыкли веcти очень активный образ жизни. Данная модель прекрасно подходит спортсменам, путешественникам, туристам.", False, False),
    (11, "http://hummer-h5.ru/", u"Купить Hummer H5", u"Защищенный смартфон HUMMER H5. Защищен по стандарту IP68. Имеет влагостойкий корпус и способен работать под водой до двух метров.", False, False),
    (12, "http://sotavsem.ru/protectedsmartphone/hummer/hummer-h5.eur.black", u"Защищенный смартфон Hummer H5 купить по цене 6900 руб", u"Купить защищенный телефон Hummer H5 с доставкой по Москве и все России. Закажите смартфон Hummer H5 не боящийся пыли и влаги в интернет магазине...", False, False),
    ...
    (14, "http://www.kit-iphone.ru/shop/shop.product_details/19/flypage.tpl/317.html", u"Hummer H5", u"Hummer H5 – старший брат популярного «неубиваемого» Hummer H11+. ... Сейчас – лучше бы купил два Хаммера, чем Хаммер и ЛендРовер.", False, False),
    (15, "http://kpkmag.ru/goods/Hummer-H5-IP67-MTK6572-2", u"Купить смартфон Hummer H5 IP67 MTK6572 /Цена. Отзывы....", u"Описание Hummer H5 IP67 MTK6572: Hummer H5 - продолжение известной линии пыле-влага-защитных бюджетных смартфонов от Hummer.", False, False),
    (16, "http://catphone.ru/products/11144635", u"Защищенный смартфон Hummer H5", u"Защищенный смартфон Hummer H5. ... Подскажите пожалуйста: Хаммер Н5, и Хаммер Н55 - это разные аппараты, или, всё же это один и тот же??", False, False),
    (17, "http://rugged.com.ua/review/hummer-h5", u"Обзор защищенного смартфона Hummer H5 – RUGGED.", u"Обзор защищенного смартфона Hummer H5. Информация от компании RUGGED. Цены, описание, характеристики, тесты товаров.", False, False),
    (18, "http://moskva.aport.ru/hummer_h5/mod752869", u"Hummer H5: цены в Москве. Купить Хаммер H5 в Москве", u"Hummer H5: цены от 9 390руб. до 9 390руб. В наличии у 1 магазина. Купить Хаммер H5 в Москве. Характеристики, описание, фото.", False, False),
    (19, "http://ru.aliexpress.com/popular/phones-hummer.html", u"телефоны hummer – Купить телефоны hummer недорого...", u"Оригинал Hummer H5 водонепроницаемый телефон смартфон андроид 4.4 IP68 телефон 3 г GPS емкостный экран WCDMA водонепроницаемый а...", False, False),
    (20, "http://tankofon.ru/index.php?route=product/product&product_id=74", u"купить Hummer H5 | Танкофон", u"Производитель: Hummer Модель: Hummer H5 Наличие: Есть в наличии Отзывов написано: 3 Написать.", False, False),
    (21, "http://sonim-tech.ru/goods.php?id=342", u"Защищенный телефон Защищенный телефон Hummer H5", u"При том, что стоимость нового Hummer H5 осталась практически на уровне предыдущих моделей, разработчики усилили параметры защищенности нового смартфона.", False, False),
    (22, "http://magmid.ru/tabletpc/waterproof-dustproof-antishock/Uphone-s930.html", u"Противоударный телефон Hummer H5 на Android; купить...", u"Защищенный противударный, пыленепроницаемый, водонепроницаемый смартфон-телефон Hummer H5 цена на неубиваемый телефон купить в интернет магазине в...", False, False),
    (23, "http://dostavkada.ru/product_10906.html", u"...Hummer h5 (Хамер H5, H55) с доставкой по москве.", u"Hummer H55 (H5) - телефон, который зарекомендовал себя с лучшей стороны. ... Многие родители, купив телефон Хаммер H55 (H5), для своего ребенка, через...", False, False),
    (24, "http://phonempire.ru/goods/%D0%9C%D0%BE%D0%B1%D0%B8%D0%BB%D1%8C%D0%BD%D1%8B%D0%B9-%D1%82%D0%B5%D0%BB%D0%B5%D1%84%D0%BE%D0%BD-Hummer-H5", u"Мобильный телефон Hummer H5, купить Мобильный...", u"Hummer H5 как раз из такой серии. Это новый смартфон, который отлично защищен от повреждений, различных воздействий и излишней влаги.", False, False),
    (25, "http://otzovik.com/reviews/smartphone_hummer_h5/", u"Отзывы о Смартфон Hummer H5", u"Смартфон Hummer H5 - отзывы. ... прикупил себе Hummer H5 до этого были (Discovery V5 пустая трата денег НЕ вздумайте покупать) остался очень доволен все...", False, False),
    (26, "http://www.cars.ru/catalog/Hummer/", u"Новый Hummer 2015 - Автомобили марки Hummer: цены...", u"Автомобили Hummer, снятые с производства и не продающиеся официально в России. Hummer H3.", False, False),
    (27, "http://4pda.ru/forum/index.php?showtopic=564309", u"Hummer H5 - Обсуждение, Смартфон 4\" | Форум", u"15 апреля 2014 Обсуждение Hummer H5 Hummer H5 Обсуждение ». Перед тем как задать вопрос, посмотрите FAQ по Android OS и Глоссарий.Всего более 11 сообщений ", False, False),
    (28, "http://ekonomimdengi.ru/", u"Телефон хаммер H5 (H55) купить - Доставка телефонов...", u"оставка телефонов хаммер H5 (H55) по Москве. ... Купить Hummer H5 с доставкой по Москве. Есть в наличии Hummer H5 черного цвета.", False, False),
    (29, "http://www.mobipukka.ru/2014/03/20/zashhishhennyj-gps-smartfon-ip68-hummer-h5/", u"Защищенный GPS-смартфон IP68 Hummer H5", u"Защищенный смартфон Hummer H5 является усовершенствованным вариантом Hummer H1.20 марта 2014", False, False),
    (30, "http://Nado-Telefon.ru/zashchishchennye-telefony/hummer-h5-ip67.html", u"Hummer H5", u"Защищенный смартфон Hummer H5 MTK6572 оснащен двухъядерным процессором MTK6572, Dual Core, с тактовой частотой 1,3 ГГц каждого ядра...", False, False),
    (31, "http://tiu.ru/Hummer-h5-1.html", u"HUMMER H5 в России. Сравнить цены, купить... - Москва", u"Широкий выбор поставщиков, у которых можно купить HUMMER H5 в России по лучшей цене. Заказать HUMMER H5 на Tiu.ru.", False, False),
    (32, "http://RusHummer.ru/forum/viewtopic.php?p=312847", u"Очень интересный концепт HUMMER H5 • HUMMER & AUTO...", u"Новости о Хаммер и других авто. ... Re: Очень интересный концепт HUMMER H5. А почему Н 5, разве Н 4 уже есть..", False, False),
    (33, "http://kitaiskii-planshet.ru/hummer-h5-mt6572.html", u"Hummer H5 противоударный водонепроницаемый Интернет...", u"7400 руб. В модели Hummer H5 подобного недостатка не имеется. Поддерживается стандарт защиты IP68, пагубные воздействия со стороны окружающей среды больше не страшны.", False, False),
    (34, "http://ShopoTam.ru/brand/hummer-h5/", u"Бренд HUMMER H5 — купить с доставкой в Москву...", u"Доставка качественных товаров известного бренда HUMMER H5 в Москву и регионы России от 6-и дней.", False, False),
    (35, "http://ChiMarket.ru/shop/show-product/452/13/hummer-h5-mtk6572-ip-67/", u"Купить китайский защищенный телефон Hummer H5 IP-67...", u"Hummer H5 - новый защищенный китайский телефон в пыле-влаго-защищённом корпусе под управлением операционной системы Android.", False, False),
    (36, "http://kitomart.ru/shop/320/desc/hummer-h5-ip67-mtk6572", u"Купить Hummer H5 IP67 MTK6572. Отзывы. Низкая цена", u"Имеет класс защиты стандарта IP67, Hummer H5 работает на базе процессора MTK6572 под управлением ОС Android 4.2.2.", False, False),
    (37, "http://www.needrom.com/download/hummer-h5/", u"Hummer H5", u"Rom for hummer h5 only MT6572 100% workLanguage: Multilanguage100% CZECHVersion for flash toolbuild.version=TLSJ_S930_HYS_A06_S152AWK_HUMMER_CN_GCS_2G_4P_W3G_2P...", False, False),
    (38, "http://activizm.ru/goods/539232/zascshiscshennyj_smartfon_hummer_h5/", u"Защищенный смартфон Hummer H5 - купить в Москве...", u"Ищете Защищенный смартфон Hummer H5? Проверенные интернет-магазины, конкурентные цены, доставка по Москве и РФ.", False, False),
    (39, "http://www.drive.ru/hummer", u"Hummer: цены, тест-драйвы, отзывы, форум, фото, видео", u"Кроме модели H4 Hummer может выпустить маленький внедорожник H5. ... Число звёзд над головой Хаммера уменьшилось в десять раз.", False, False),
    (40, "http://www.minmin.ru/index/good/1473", u"Hummer H5 - Защищённый смартфон", u"Hummer H5– старший брат популярного «неубиваемого» Hummer H11+. Тот же ударопрочный, водонепроницаемый корпус, та же мощная батарея…", False, False),
    (41, "http://www.pleer.ru/_180022_hummer_h5.html", u"Hummer H5 - купить сотовый телефон Хаммер по лучшей...", u"Hummer H5 - это уникальный по общим составляющим смартфон. С одной стороны - это классический бюджетный смартфон на операционной системе Android, однако, снабженный очень неплохими для своей цены характеристиками и, к тому же...", False, False),
    (42, "http://russian.alibaba.com/goods/hummer-h5-phone.html", u"Hummer H5 Телефон, Поиск лучших товаров Hummer...", u"Посик Высшего качества Hummer H5 Телефон, Hummer H5 Телефон Компаний, Hummer H5 Телефон Производителей на Alibaba.com.", False, False),
    (43, "http://mobilhits.ru/products/hummer-h5-", u"Hummer H5", u"Защищенный телефон Hummer H5 - устройство из будущего. ... Он очень похож на своего теску - внедорожник Хаммер, поэтому имеет фото авто на задней...", False, False),
    (44, "http://irecommend.ru/content/smartfon-bronenosets", u"Мобильный телефон Hummer H5 - «Смартфон броненосец»...", u"Сегодня делюсь с вами своим новым приобретением - смартфоном Хаммер Н5. ... написать модератору. CrockXP рекомендует Мобильный телефон Hummer H5.", False, False),
    (45, "http://hummerclubrus.ru/forums/showthread.php?p=916109", u"Hummer H5 тестил кто? | Форум", u"23 декабря 2014 xenon4ek надеюсь выдержит, хотя у меня ни квадрика, ни снегохода нет, покупал Н5 для Хомяка)))Всего более 50 сообщений ", False, False),
    (46, "http://electronics.wikimart.ru/communication/cell/model/64702598/mobilnyjj_telefon_hummer_h5_plus/", u"Мобильный телефон Hummer Hummer H5 Plus | Викимарт", u"Мобильный телефон Hummer Hummer H5 Plus. Характеристики Описание. 9489 Р. ... Описание. Защищенный смартфон Hummer H5 со степенью защиты IP68.", False, False),
    (47, "http://www.hummer-h5.de/", u"hummer-h5.de", u"Ссылки на страницу содержат: Hummer H5....", False, False),
    (48, "http://dialogdv.ru/product/hummer-h55/", u"Hummer H55 - купить неубиваемый Android-смартфон...", u"Поэтому выгоднее прямо сейчас купить телефон хаммер на нашем сайте dialogdv.ru. ... Hummer H55 отзывы. отзыв о телефоне Хаммере.", False, False),
    (49, "http://my.mail.ru/mail/hummer_h5/", u"Николай Елагин - на Мой Мир@Mail.ru", u"Николай Елагин - . Страница пользователя hummer_h5@mail.ru социальной сети Мой Мир.", False, False),
    (50, "http://luxury-info.ru/catalog/auto/Hummer/Hummer-H5.html", u"Hummer H5 - Автомобили - Luxury-info.ru Портал о мире...", u"Hummer » H5. Модельный ряд. ... Может и дорог-то не останется для настоящего «Хаммера». Вернее их отсутствия.", False, False),
]
